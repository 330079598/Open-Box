...
```bash
curl -fsSL https://ghfast.top/https://raw.githubusercontent.com/330079598/Open-Box/main/scripts/install.sh | sh -s -- --mirror
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/330079598/Open-Box/main/scripts/update.sh | sh
```
...
curl -fsSL https://raw.githubusercontent.com/330079598/Open-Box/main/scripts/uninstall.sh | sh

# 连 data/ 一起删,彻底清干净
curl -fsSL https://raw.githubusercontent.com/330079598/Open-Box/main/scripts/uninstall.sh | sh -s -- --purge
```
