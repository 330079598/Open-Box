...
```bash
curl -fsSL https://raw.githubusercontent.com/330079598/Open-Box/stone/scripts/install.sh | sh
```

GitHub 访问不畅时用加速版(脚本内置了几个加速站,会依次探测自动挑一个能用的):

```bash
curl -fsSL https://ghfast.top/https://raw.githubusercontent.com/330079598/Open-Box/stone/scripts/install.sh | sh -s -- --mirror
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/330079598/Open-Box/stone/scripts/update.sh | sh
```
...
curl -fsSL https://raw.githubusercontent.com/330079598/Open-Box/stone/scripts/uninstall.sh | sh

# 连 data/ 一起删,彻底清干净
curl -fsSL https://raw.githubusercontent.com/330079598/Open-Box/stone/scripts/uninstall.sh | sh -s -- --purge
```
